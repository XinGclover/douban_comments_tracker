...
def backup_table_csv(conn, table_name, backup_dir):
    ...
    with conn.cursor() as cur, open(backup_path, 'w', newline='', encoding='utf-8') as f:
...
def main():
    ...
    for table in DB_TABLES:
        try:
            backup_table_csv(conn, table, backup_dir)
