...
TASKS = [
    {
        ...
        "cmd": ["uv", "run", "python", "-m", "scraper.douban_post_scraper"],
        "category": "Douban Scraper",
        "desc": "从 Douban 抓取主贴与回复",
    },
    {
        "name": "🦎 根据关键词抓取相关讨论 topics ",
        "cmd": ["uv", "run", "python", "-m", "scraper.douban_topics_statistic_scraper"],
        "category": "Douban Scraper",
        "desc": "从 Douban 抓取 post 列表",
    },
    {
        "name": "🦎 搜集小组成员名单",
        "cmd": ["uv", "run", "python", "-m", "scraper.douban_group_members"],
        "category": "Douban Scraper",
        "desc": "从 Douban 抓取小组成员名单",
    },
    {
        "name": "🦎 爬取剧集短评",
        "cmd": ["uv", "run", "python", "-m", "scraper.douban_comments_scraper"],
        "category": "Douban Scraper",
    ...
    {
        "name": "📊 结巴分词",
        "cmd": ["uv", "run", "python", "-m", "analysis.jieba_words"],
        "category": "Common Analysis",
        "desc": "读取 comment 表，进行结巴分词",
    },
    {
        "name": "🥝 爬取爱奇艺实时热度",
        "cmd": ["uv", "run", "python", "-m", "iqiyi.heat_scraper"],
        "category": "Iqiyi Scraper",
        "desc": "从爱奇艺抓取实时热度数据",
    },
    {
        "name": "🔧 更新cookies",
        "cmd": ["uv", "run", "python", "-m", "update_cookie"],
        "category": "Tools",
        "desc": "更新 cookies",
    },
    {
